...
\usepackage{xspace}
\newcommand{\whyml}{\gls{WhyML}\xspace}
\newcommand{\whythree}{\gls{Why3}\xspace}
\newcommand{\cvc}{\gls{CVC5}\xspace}
\newcommand{\altergo}{\gls{Alt-Ergo}\xspace}
\newcommand{\zthree}{\gls{Z3}\xspace}
\newcommand{\ocaml}{\gls{OCaml}\xspace}
\newcommand{\cml}{\gls{CakeML}\xspace}
\newcommand{\gospel}{\gls{GOSPEL}\xspace}
\newcommand{\cameleer}{\gls{Cameleer}\xspace}
\newcommand{\gantt}{\gls{Gantt Chart}\xspace}
\newcommand{\compcert}{\gls{CompCert}\xspace}
\usepackage{caption} 
...
% Fontification of source code listingsConfig/5_packages.tex
