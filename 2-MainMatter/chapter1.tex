...
For the chapter \ref{cha:Pipeline} presents the goal pipeline, the necessary tool modifications to accommodate that pipeline and
a set of examples showing how \ocaml + \gospel code can be correctly translated into \cml. 

Chapter \ref{cha:Extraction} presents the \cml subset to which this study is restricted, and identifies the limitations and
inaccuracies in the current extraction mechanism from \whythree.

Chapter \ref{cha:Translation} explains the creation of a full translation scheme from \cml with \gospel annotations to \whyml.

In chapter \ref{cha:Comparative_Evaluation} presents a complete and extensive use case applied for both approaches, in order to 
create a fair comparison between the two approaches evaluated in this work.

Finally, chapter \ref{cha:Conclusion} draws and presents the conclusions as critically as possible, discussing both
approaches and how they compare. It also outlines of this work and possible directions for future work.
