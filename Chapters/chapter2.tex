...
not only intuitively effective but also formally complete as a system for reasoning about program correctness.
...
The influence of weakest preconditions is particularly evident in modern deductive verification tools such as Why3, Boogie, 
Frama-C, and Dafny.
...
For the standard compiler toolchain features, OCaml has both a high-performance native-code compiler (\textbf{ocamlopt}) and a 
...
\textbf{Verification-Oriented Language Features}

\textbf{ADTs} (Algebraic Data Types)
...
\textbf{First-Class and Higher-Order Functions}
...
\textbf{Type Abstraction and Encapsulation}
...
However, it was also shaped by practical programming needs, leading to the inclusion of imperative features and a 
...
combines strong type safety with notable flexibility in programming style.

%%https://courses.grainger.illinois.edu/cs422/sp2016/lectures/sml97-defn.pdf
