...
iteration. This example highlights \ocaml's support for recursion through an auxiliary function, \inlinecode{fact\_aux}, 
...
The main function \inlinecode{fact} initializes the auxiliary call with appropriate base values. The GOSPEL annotations 
